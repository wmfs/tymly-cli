...
async function solicitDetails (blueprintName, profile) {
  ...
  blueprintInfo = await blueprintDetails(blueprintInfo, profile)
  console.log()
  blueprintInfo = await authorDetails(blueprintInfo, profile)
  console.log()
  blueprintInfo = await buildDetails(blueprintInfo, profile)
  console.log()
